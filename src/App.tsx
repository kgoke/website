        ...
        <div className="w-full h-screen overflow-hidden flex">
            ...
            <div className="flex flex-col w-full h-full justify-center items-center absolute z-20 bg-black bg-opacity-70">
                <ul className='flex flex-col justify-center items-center'>
                    <li>
                        <a className='text-4xl text-pink-300 hover:font-bold' href='https://www.github.com/kgoke' target='_blank'>Github</a>
                    </li>
                    <li>
                        <a className='text-4xl text-pink-300 hover:font-bold' href='https://www.linkedin.com/in/keegan-goecke-97638821b' target='_blank'>LinkedIn</a>.
                    </li>
                    <li>
                        <a className='text-4xl text-pink-300 hover:font-bold' href='https://www.youtube.com/@kgoke' target='_blank'>YouTube</a>.
                    </li>
